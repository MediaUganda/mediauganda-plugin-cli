<?php
/**
 * Generate a new installation of MU_Plugin
 *
 * @category CLI
 * @package  MU_Plugin-cli
...
class NewCommand extends Command
{
	...
	public function configure()
	{
		$this
			->setName('new')
			->setDescription('Create a new MU_Plugin Theme installation')
	...
	public function execute(InputInterface $input, OutputInterface $output)
	{
		...
		$question = new Question("Name of your theme? <info>(MU_Plugin)</info> ", null);
		$themeName = $helper->ask($input, $output, $question);

		$question = new Question("PHP Namespace of your theme? <info>(MU_Plugin)</info> ", null);
	...
	/**
	 * Download the lates MU_Plugin release
	 *
	...
	private function renameAllTheThings($directory, OutputInterface $output, $themeName = null, $namespace = null, $description = null, $wp_url = null, $themeURI = null, $author = null, $authorURI = null, $themeVersion = null)
	{
		...
		foreach ($file_info as $file) {
			...
			if (! is_null($namespace)) {
				...
				$str = str_replace("use MU_Plugin", "use " . $namespace, $str);
				$str = str_replace("namespace MU_Plugin", "namespace " . $namespace, $str);
				$str = str_replace("MU_Plugin\\", $namespace . "\\", $str);
				$str = str_replace("MU_Plugin\Init", $namespace . "\Init", $str);
			}

			if (! is_null($themeName)) {
				$str = str_replace("MU_Plugin", $themeName, $str);
			}
